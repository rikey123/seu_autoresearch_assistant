...
export default {
  ...
  browser: {
    title: 'ブラウザー', settings: 'ブラウザー設定', desktopOnly: '内蔵ブラウザーは SEU研究ワークベンチ Desktop でのみ利用できます。', newTab: '新しいタブ',
  ...
  research: {
    ...
    workflows: {
      templatesTitle: 'テンプレートライブラリ',
      templatesLoading: 'テンプレートを読み込み中…',
      templatesLoadFailed: 'テンプレートライブラリの読み込みに失敗しました。',
      retry: '再試行',
      useTemplate: 'このテンプレートを使う',
      nodeCount: '{count} ノード',
      myWorkflowsTitle: 'マイワークフロー',
      flowsLoading: 'ワークフローを読み込み中…',
      flowsLoadFailed: 'ワークフロー一覧の読み込みに失敗しました。',
      flowsEmpty: 'ワークフローはまだありません',
      flowsEmptyHint: '上のテンプレートライブラリから選んで、最初のリサーチパイプラインを作成しましょう。',
      open: '開く',
      delete: '削除',
      deleteConfirm: '削除',
      cancel: 'キャンセル',
      deleteConfirmText: 'ワークフロー「{name}」を削除しますか？この操作は元に戻せません。',
      deleteSuccess: 'ワークフローを削除しました。',
      deleteFailed: 'ワークフローの削除に失敗しました。',
      untitledFlow: '無題のワークフロー',
      createModalTitle: 'テンプレートからワークフローを作成',
      createNameLabel: 'ワークフロー名',
      createNamePlaceholder: 'このリサーチパイプラインに名前を付ける',
    ...
    artifacts: {
      allTypes: 'すべての種類',
      keywordPlaceholder: 'タイトルまたは実行 ID を検索',
      loading: '成果を読み込み中…',
      loadFailed: '成果一覧の読み込みに失敗しました。',
      retry: '再試行',
      empty: 'まだ成果はありません。LaTeX 文書をコンパイルすると、生成された PDF が自動的にここに登録されます。ワークフロー実行の成果もこの一覧に表示されます。',
      emptyFiltered: '条件に一致する成果はありません。',
      untitled: '無題の成果',
      sourceNone: '実行元なし',
      preview: 'プレビュー',
      previewFrame: '成果プレビュー',
      openInNewWindow: '新しいウィンドウで開く',
      previewMetaTitle: 'プレビュー情報',
      previewEmpty: 'この成果にはまだプレビュー情報がありません。',
      close: '閉じる',
      sendToChat: 'チャットへ送信',
      sendToChatSuccess: '成果をチャットへ送信しました。',
      sendToChatFailed: '成果のチャットへの送信に失敗しました。',
      delete: '削除',
      deleteConfirm: '削除',
      deleteConfirmText: '「{name}」を成果一覧から削除しますか？登録記録のみが削除されます。',
      deleteFailed: '成果の削除に失敗しました。',
      deleteSuccess: '成果を削除しました。',
      cancel: 'キャンセル',
      typeLabels: {
        html: 'HTML ページ',
        svg: 'SVG 図',
    ...
    latex: {
      ...
      compile: 'コンパイル',
      compiling: 'コンパイル中…',
      previewTitle: 'PDF プレビュー',
      previewEmpty: 'コンパイルすると PDF プレビューが表示されます。',
      previewFailed: 'PDF プレビューの読み込みに失敗しました。',
      errorPanelTitle: 'コンパイルエラー',
      noErrors: 'エラーはありません。',
      statusQueued: '待機中',
      statusRunning: 'コンパイル中',
      statusCompleted: '完了',
      statusFailed: '失敗',
      engineUnavailable: 'サーバーで Tectonic を利用できません。TECTONIC_BIN を設定するか、tectonic を PATH にインストールしてください。',
      compileConflict: 'このドキュメントはすでにコンパイル待ちまたは実行中です。',
      loadFailed: 'LaTeX ドキュメントの読み込みに失敗しました。',
      lineLabel: '{line} 行目',
      loading: '読み込み中…',
    ...
    rag: {
      ...
      delete: '削除',
      cancel: 'キャンセル',
      deleteConfirmText: 'ナレッジベース「{name}」を削除しますか？メンバー論文と質問履歴も削除されます。',
      deleted: 'ナレッジベースを削除しました。',
      deleteFailed: 'ナレッジベースの削除に失敗しました。',
      selectHint: 'ナレッジベースを選択して、論文を管理し質問してください。',
      status: {
        unindexed: '未インデックス',
        indexing: 'インデックス中',
        indexed: 'インデックス済み',
      ...
      index: 'インデックスを構築',
      reindex: 'インデックスを再構築',
      indexCompleted: 'インデックスを構築しました。',
      indexFailed: 'インデックスの構築に失敗しました。',
      chunks: '{count} チャンク（{engine}）',
      membersTitle: 'メンバー論文',
      memberPlaceholder: 'ライブラリから論文を選択…',
      memberAdd: '論文を追加',
      memberAdded: 'ナレッジベースに論文を追加しました。',
      memberAddFailed: '論文の追加に失敗しました。',
      membersEmpty: 'このナレッジベースにはまだ論文がありません。',
      memberFileMissing: 'PDF が見つかりません',
      memberRemove: '削除',
      memberRemoved: 'ナレッジベースから論文を削除しました。',
      memberRemoveFailed: '論文の削除に失敗しました。',
      memberRemoveConfirmText: '「{name}」をこのナレッジベースから削除しますか？',
      askTitle: 'このナレッジベースに質問',
      questionPlaceholder: 'このナレッジベースの論文について質問…',
      ask: '質問',
      askFailed: '質問に失敗しました。',
      askNeedsIndex: '先にインデックスを構築してください — 質問にはインデックス済みのナレッジベースが必要です。',
      historyEmpty: 'まだ質問はありません。',
      questionFailed: '質問に失敗しました。',
  ...
  runtimeVersions: {
    ...
    dataDirectoryEnvRestart: '変更後は SEU研究ワークベンチ を完全に終了して再度開いてください。Windows または Linux のデスクトップアプリで古い値が残る場合は、サインアウトして再度サインインしてください。',
    cliUpdateDescription: 'Hermes Runtime 0.19.1 以降では、次のコマンドで内蔵 Hermes Agent のみを更新できます。SEU研究ワークベンチ デスクトップアプリや Web UI は更新されません。実行前に SEU研究ワークベンチ を完全に終了してください：',
    webUiTitle: 'Web UI',
    platform: 'プラットフォーム',
    ...
    runtimeDirectorySaved: 'Runtime の移行を予約しました。SEU研究ワークベンチ を再起動すると実行されます。',
    runtimeMigrationPending: '移行先：{directory}',
    runtimeMigrationFailed: '保存先の移行に失敗したため、以前の保存先を引き続き使用します',
    runtimeActivationFailed: '選択した Runtime を起動できなかったため、SEU研究ワークベンチ は別のインストール済みバージョンを使用しています',
    active: '有効',
    installed: 'インストール済み',
    download: 'ダウンロード',
    ...
    activateSuccess: 'バージョン選択を保存しました。SEU研究ワークベンチ を再起動すると反映されます。',
  ...
  chat: {
    ...
    pushNotConfigured: '有効にする前に、SEU研究ワークベンチ の「デバイス接続」でメッセージプッシュを設定してください。',
  ...
  settings: {
    ...
    display: {
      ...
      approvalNotificationBody: 'Open SEU研究ワークベンチ to review and respond.',
