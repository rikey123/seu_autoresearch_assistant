...
export default {
  ...
  browser: {
    title: '浏览器', settings: '浏览器设置', desktopOnly: '内置浏览器仅在 SEU科研工作台 桌面端可用。', newTab: '新标签页',
  ...
  research: {
    ...
    papers: {
      ...
      deleteConfirm: '删除',
      cancel: '取消',
      deleteConfirmText: '确定从文献库删除「{name}」吗？已保存的 PDF 文件将一并移除。',
      deleteFailed: '删除文献失败。',
      deleteSuccess: '文献已删除。',
      uploadFailed: '导入失败，仅支持 PDF 文件。',
      uploadSuccess: '文献已导入。',
      backToList: '返回文献列表',
      previewFrame: 'PDF 预览',
      reload: '重新加载',
    ...
    workflows: {
      ...
      templatesLoadFailed: '模板库加载失败。',
      retry: '重试',
      useTemplate: '使用此模板',
      nodeCount: '{count} 个节点',
      myWorkflowsTitle: '我的流程',
      flowsLoading: '正在加载流程…',
      flowsLoadFailed: '流程列表加载失败。',
      flowsEmpty: '还没有流程',
      flowsEmptyHint: '从上方模板库选择一个模板，创建你的第一条科研流水线。',
      open: '打开',
      delete: '删除',
      deleteConfirm: '删除',
      cancel: '取消',
      deleteConfirmText: '删除流程“{name}”？该操作不可撤销。',
      deleteSuccess: '流程已删除。',
      deleteFailed: '删除流程失败。',
      untitledFlow: '未命名流程',
      createModalTitle: '从模板创建流程',
      createNameLabel: '流程名称',
      createNamePlaceholder: '为这条科研流水线命名',
    ...
    artifacts: {
      allTypes: '全部类型',
      keywordPlaceholder: '搜索名称或运行 ID',
      loading: '正在加载成果…',
      loadFailed: '成果列表加载失败。',
      retry: '重试',
      empty: '还没有研究成果。编译 LaTeX 文档后，生成的 PDF 会自动登记到这里；工作流运行产出的图表与报告也将显示在此列表。',
      emptyFiltered: '没有符合筛选条件的成果。',
      untitled: '未命名成果',
      sourceNone: '无运行来源',
      preview: '预览',
      previewFrame: '成果预览',
      openInNewWindow: '新窗口打开',
      previewMetaTitle: '预览信息',
      previewEmpty: '该成果暂无预览信息。',
      close: '关闭',
      sendToChat: '发送到聊天',
      sendToChatSuccess: '成果已发送到聊天。',
      sendToChatFailed: '发送成果到聊天失败。',
      delete: '删除',
      deleteConfirm: '删除',
      deleteConfirmText: '确定从成果列表删除「{name}」吗？仅移除登记记录。',
      deleteFailed: '删除成果失败。',
      deleteSuccess: '成果已删除。',
      cancel: '取消',
      typeLabels: {
    ...
    latex: {
      ...
      compiling: '编译中…',
      previewTitle: 'PDF 预览',
      previewEmpty: '编译文档后即可查看 PDF 预览。',
      previewFailed: 'PDF 预览加载失败。',
      errorPanelTitle: '编译错误',
      noErrors: '暂无错误。',
      statusQueued: '排队中',
      statusRunning: '编译中',
      statusCompleted: '已完成',
      statusFailed: '失败',
      engineUnavailable: '服务器上没有可用的 Tectonic 编译器。请设置 TECTONIC_BIN 或将 tectonic 加入 PATH。',
      compileConflict: '该文档已有编译任务在排队或运行中。',
      loadFailed: 'LaTeX 文档加载失败。',
      lineLabel: '第 {line} 行',
      loading: '加载中…',
    ...
    rag: {
      ...
      delete: '删除',
      cancel: '取消',
      deleteConfirmText: '删除知识库“{name}”？其成员论文与问答历史将一并删除。',
      deleted: '知识库已删除。',
      deleteFailed: '删除知识库失败。',
      selectHint: '选择一个知识库，管理成员论文并进行提问。',
      status: {
        unindexed: '未索引',
        indexing: '索引中',
        indexed: '已索引',
      ...
      index: '构建索引',
      reindex: '重建索引',
      indexCompleted: '索引构建完成。',
      indexFailed: '索引构建失败。',
      chunks: '{count} 个片段 · {engine}',
      membersTitle: '成员论文',
      memberPlaceholder: '从论文库中选择…',
      memberAdd: '添加论文',
      memberAdded: '已加入知识库。',
      memberAddFailed: '添加论文失败。',
      membersEmpty: '此知识库还没有论文。',
      memberFileMissing: 'PDF 缺失',
      memberRemove: '移除',
      memberRemoved: '已从知识库移除。',
      memberRemoveFailed: '移除论文失败。',
      memberRemoveConfirmText: '将“{name}”从该知识库移除？',
      askTitle: '向知识库提问',
      questionPlaceholder: '针对库内论文提出问题…',
      ask: '提问',
      askFailed: '提问失败。',
      askNeedsIndex: '请先构建索引——提问需要已建立索引的知识库。',
  ...
  runtimeVersions: {
    ...
    dataDirectoryEnvRestart: '修改后请完全退出并重新打开 SEU科研工作台。若 Windows 或 Linux 桌面端仍读取旧值，请注销并重新登录系统。',
    cliUpdateDescription: 'Hermes Runtime 0.19.1 及以上版本支持通过以下命令单独升级内置的 Hermes Agent；该命令不会升级 SEU科研工作台 桌面端或 Web UI。执行前请先完全退出 SEU科研工作台：',
    webUiTitle: 'Web UI',
    platform: '平台',
    ...
    runtimeDirectorySaved: 'Runtime 迁移已安排，重启 SEU科研工作台 后执行。',
    runtimeMigrationPending: '待迁移到：{directory}',
    runtimeMigrationFailed: '存储目录迁移失败，已继续使用原目录',
    runtimeActivationFailed: '所选 Runtime 无法启动，SEU科研工作台 已改用其他已安装版本',
    active: '已启用',
    installed: '已安装',
    download: '下载',
    ...
    activateSuccess: '版本选择已保存，重启 SEU科研工作台 后生效。',
  ...
  chat: {
    ...
    pushEnabled: '是否推送',
    pushNotConfigured: '请先到 SEU科研工作台「设备互联」中配置消息推送。',
  ...
  workflow: {
    ...
    runs: {
      ...
      deleteSuccess: '执行记录已删除',
          notificationTitle: '工作流「{name}」运行结束',
      notificationCompleted: '运行已完成。',
      notificationFailed: '运行失败，打开运行详情查看节点错误。',
      notificationCanceled: '运行已取消。',
},
    inspector: {
      selected: '选中节点',
      none: '未选择节点',
  ...
  settings: {
    ...
    display: {
      ...
      notifyOnApprovalHint: 'SEU科研工作台 不在前台时，出现新的审批或澄清会发送系统通知；通知不显示敏感详情',
      ...
      approvalNotificationBody: '打开 SEU科研工作台 查看并处理。',
