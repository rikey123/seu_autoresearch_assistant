...
export default {
  ...
  browser: {
    title: '瀏覽器', settings: '瀏覽器設定', desktopOnly: '內建瀏覽器僅在 SEU科研工作台 桌面版可用。', newTab: '新分頁',
  ...
  research: {
    ...
    workflows: {
      templatesTitle: '範本庫',
      templatesLoading: '正在載入範本…',
      templatesLoadFailed: '範本庫載入失敗。',
      retry: '重試',
      useTemplate: '使用此範本',
      nodeCount: '{count} 個節點',
      myWorkflowsTitle: '我的流程',
      flowsLoading: '正在載入流程…',
      flowsLoadFailed: '流程列表載入失敗。',
      flowsEmpty: '還沒有流程',
      flowsEmptyHint: '從上方範本庫選擇一個範本，建立你的第一條科研流水線。',
      open: '開啟',
      delete: '刪除',
      deleteConfirm: '刪除',
      cancel: '取消',
      deleteConfirmText: '刪除流程「{name}」？此操作無法復原。',
      deleteSuccess: '流程已刪除。',
      deleteFailed: '刪除流程失敗。',
      untitledFlow: '未命名流程',
      createModalTitle: '從範本建立流程',
      createNameLabel: '流程名稱',
      createNamePlaceholder: '為這條科研流水線命名',
    ...
    artifacts: {
      allTypes: '全部類型',
      keywordPlaceholder: '搜尋名稱或執行 ID',
      loading: '正在載入成果…',
      loadFailed: '成果清單載入失敗。',
      retry: '重試',
      empty: '還沒有研究成果。編譯 LaTeX 文件後，產生的 PDF 會自動登記到這裡；工作流執行產出的圖表與報告也會顯示在此清單。',
      emptyFiltered: '沒有符合篩選條件的成果。',
      untitled: '未命名成果',
      sourceNone: '無執行來源',
      preview: '預覽',
      previewFrame: '成果預覽',
      openInNewWindow: '新視窗開啟',
      previewMetaTitle: '預覽資訊',
      previewEmpty: '此成果尚無預覽資訊。',
      close: '關閉',
      sendToChat: '傳送到聊天',
      sendToChatSuccess: '成果已傳送到聊天。',
      sendToChatFailed: '傳送成果到聊天失敗。',
      delete: '刪除',
      deleteConfirm: '刪除',
      deleteConfirmText: '確定從成果清單刪除「{name}」嗎？僅移除登記記錄。',
      deleteFailed: '刪除成果失敗。',
      deleteSuccess: '成果已刪除。',
      cancel: '取消',
      typeLabels: {
    ...
    latex: {
      ...
      compiling: '編譯中…',
      previewTitle: 'PDF 預覽',
      previewEmpty: '編譯文件後即可檢視 PDF 預覽。',
      previewFailed: 'PDF 預覽載入失敗。',
      errorPanelTitle: '編譯錯誤',
      noErrors: '目前沒有錯誤。',
      statusQueued: '排隊中',
      statusRunning: '編譯中',
      statusCompleted: '已完成',
      statusFailed: '失敗',
      engineUnavailable: '伺服器上沒有可用的 Tectonic 編譯器。請設定 TECTONIC_BIN 或將 tectonic 加入 PATH。',
      compileConflict: '此文件已有編譯任務在排隊或執行中。',
      loadFailed: 'LaTeX 文件載入失敗。',
      lineLabel: '第 {line} 行',
      loading: '載入中…',
    ...
    rag: {
      ...
      retry: '重試',
      empty: '還沒有知識庫',
      paperCount: '{count} 篇論文',
      delete: '刪除',
      cancel: '取消',
      deleteConfirmText: '刪除知識庫「{name}」？其成員論文與問答歷史將一併刪除。',
      deleted: '知識庫已刪除。',
      deleteFailed: '刪除知識庫失敗。',
      selectHint: '選擇一個知識庫，管理成員論文並進行提問。',
      status: {
        unindexed: '未索引',
        indexing: '索引中',
        indexed: '已索引',
      ...
      index: '建立索引',
      reindex: '重建索引',
      indexCompleted: '索引建立完成。',
      indexFailed: '索引建立失敗。',
      chunks: '{count} 個片段 · {engine}',
      membersTitle: '成員論文',
      memberPlaceholder: '從論文庫中選擇…',
      memberAdd: '新增論文',
      memberAdded: '已加入知識庫。',
      memberAddFailed: '新增論文失敗。',
      membersEmpty: '此知識庫還沒有論文。',
      memberFileMissing: 'PDF 遺失',
      memberRemove: '移除',
      memberRemoved: '已從知識庫移除。',
      memberRemoveFailed: '移除論文失敗。',
      memberRemoveConfirmText: '將「{name}」從該知識庫移除？',
      askTitle: '向知識庫提問',
      questionPlaceholder: '針對庫內論文提出問題…',
      ask: '提問',
      askFailed: '提問失敗。',
      askNeedsIndex: '請先建立索引——提問需要已建立索引的知識庫。',
      historyEmpty: '還沒有提問紀錄。',
      questionFailed: '提問失敗。',
  ...
  runtimeVersions: {
    ...
    dataDirectoryEnvRestart: '修改後請完全結束並重新開啟 SEU科研工作台。若 Windows 或 Linux 桌面端仍讀取舊值，請登出並重新登入系統。',
    cliUpdateDescription: 'Hermes Runtime 0.19.1 及以上版本支援透過以下指令單獨升級內建的 Hermes Agent；此指令不會升級 SEU科研工作台 桌面端或 Web UI。執行前請先完全結束 SEU科研工作台：',
    webUiTitle: 'Web UI',
    platform: '平台',
    ...
    runtimeDirectorySaved: 'Runtime 遷移已排程，重新啟動 SEU科研工作台 後執行。',
    runtimeMigrationPending: '待遷移至：{directory}',
    runtimeMigrationFailed: '儲存目錄遷移失敗，已繼續使用原目錄',
    runtimeActivationFailed: '所選 Runtime 無法啟動，SEU科研工作台 已改用其他已安裝版本',
    active: '已啟用',
    installed: '已安裝',
    download: '下載',
    ...
    activateSuccess: '版本選擇已儲存，重啟 SEU科研工作台 後生效。',
  ...
  chat: {
    ...
    pushEnabled: '是否推送',
    pushNotConfigured: '請先到 SEU科研工作台「裝置互聯」中設定訊息推送。',
  ...
  settings: {
    ...
    display: {
      ...
      notifyOnApprovalHint: 'SEU科研工作台 不在前景時，新的審批或澄清會傳送系統通知；通知不顯示敏感詳情',
      ...
      approvalNotificationBody: '開啟 SEU科研工作台 查看並處理。',
