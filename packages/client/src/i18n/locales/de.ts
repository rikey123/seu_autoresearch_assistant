...
export default {
  ...
  research: {
    ...
    workflows: {
      templatesTitle: 'Vorlagenbibliothek',
      templatesLoading: 'Vorlagen werden geladen…',
      templatesLoadFailed: 'Vorlagenbibliothek konnte nicht geladen werden.',
      retry: 'Erneut versuchen',
      useTemplate: 'Diese Vorlage verwenden',
      nodeCount: '{count} Knoten',
      myWorkflowsTitle: 'Meine Workflows',
      flowsLoading: 'Workflows werden geladen…',
      flowsLoadFailed: 'Workflows konnten nicht geladen werden.',
      flowsEmpty: 'Noch keine Workflows',
      flowsEmptyHint: 'Wählen Sie oben eine Vorlage, um Ihre erste Research-Pipeline zu erstellen.',
      open: 'Öffnen',
      delete: 'Löschen',
      deleteConfirm: 'Löschen',
      cancel: 'Abbrechen',
      deleteConfirmText: 'Workflow "{name}" löschen? Dies kann nicht rückgängig gemacht werden.',
      deleteSuccess: 'Workflow gelöscht.',
      deleteFailed: 'Workflow konnte nicht gelöscht werden.',
      untitledFlow: 'Unbenannter Workflow',
      createModalTitle: 'Workflow aus Vorlage erstellen',
      createNameLabel: 'Workflow-Name',
      createNamePlaceholder: 'Benennen Sie diese Research-Pipeline',
    ...
    artifacts: {
      allTypes: 'Alle Typen',
      keywordPlaceholder: 'Titel oder Run-ID suchen',
      loading: 'Artefakte werden geladen…',
      loadFailed: 'Artefakte konnten nicht geladen werden.',
      retry: 'Erneut versuchen',
      empty: 'Noch keine Artefakte. Nach dem Kompilieren eines LaTeX-Dokuments wird das erzeugte PDF automatisch hier registriert; Abbildungen und Berichte aus Workflow-Läufen erscheinen ebenfalls in dieser Liste.',
      emptyFiltered: 'Keine Artefakte entsprechen den aktuellen Filtern.',
      untitled: 'Unbenanntes Artefakt',
      sourceNone: 'ohne Lauf-Quelle',
      preview: 'Vorschau',
      previewFrame: 'Artefaktvorschau',
      openInNewWindow: 'In neuem Fenster öffnen',
      previewMetaTitle: 'Vorschaudetails',
      previewEmpty: 'Dieses Artefakt hat noch keine Vorschaudetails.',
      close: 'Schließen',
      sendToChat: 'An Chat senden',
      sendToChatSuccess: 'Artefakt an den Chat gesendet.',
      sendToChatFailed: 'Artefakt konnte nicht an den Chat gesendet werden.',
      delete: 'Löschen',
      deleteConfirm: 'Löschen',
      deleteConfirmText: '„{name}“ aus der Artefaktliste entfernen? Nur der Registrierungseintrag wird entfernt.',
      deleteFailed: 'Artefakt konnte nicht gelöscht werden.',
      deleteSuccess: 'Artefakt gelöscht.',
      cancel: 'Abbrechen',
      typeLabels: {
        html: 'HTML-Seite',
        svg: 'SVG-Grafik',
        pptx: 'PPTX-Präsentation',
        drawio: 'draw.io-Diagramm',
        pdf: 'PDF-Dokument',
    ...
    latex: {
      ...
      source: 'LaTeX-Quelltext',
      save: 'Speichern',
      saved: 'Gespeichert',
      compile: 'Kompilieren',
      compiling: 'Kompiliere…',
      previewTitle: 'PDF-Vorschau',
      previewEmpty: 'Kompiliere das Dokument, um die PDF-Vorschau zu sehen.',
      previewFailed: 'PDF-Vorschau konnte nicht geladen werden.',
      errorPanelTitle: 'Kompilierungsfehler',
      noErrors: 'Keine Fehler.',
      statusQueued: 'In Warteschlange',
      statusRunning: 'Kompiliert',
      statusCompleted: 'Abgeschlossen',
      statusFailed: 'Fehlgeschlagen',
      engineUnavailable: 'Tectonic ist auf dem Server nicht verfügbar. Setze TECTONIC_BIN oder installiere tectonic im PATH.',
      compileConflict: 'Für dieses Dokument wird bereits kompiliert oder eine Kompilierung ist in der Warteschlange.',
      loadFailed: 'LaTeX-Dokumente konnten nicht geladen werden.',
    ...
    rag: {
      ...
      namePlaceholder: 'Name der Wissensbasis',
      descriptionPlaceholder: 'Beschreibung (optional)',
      create: 'Erstellen',
      created: 'Wissensbasis erstellt.',
      createFailed: 'Erstellen der Wissensbasis fehlgeschlagen.',
      loading: 'Wissensbasen werden geladen…',
      loadFailed: 'Laden der Wissensbasen fehlgeschlagen.',
      retry: 'Erneut versuchen',
      empty: 'Noch keine Wissensbasen',
      paperCount: '{count} Paper',
      delete: 'Löschen',
      cancel: 'Abbrechen',
      deleteConfirmText: 'Wissensbasis "{name}" löschen? Mitgliedschaften und der Frage-Antwort-Verlauf werden entfernt.',
      deleted: 'Wissensbasis gelöscht.',
      deleteFailed: 'Löschen der Wissensbasis fehlgeschlagen.',
      selectHint: 'Wähle eine Wissensbasis, um ihre Paper zu verwalten und Fragen zu stellen.',
      status: {
      ...
      indexCompleted: 'Index erstellt.',
      indexFailed: 'Indizierung fehlgeschlagen.',
      chunks: '{count} Chunks über {engine}',
      membersTitle: 'Mitglieds-Paper',
      memberPlaceholder: 'Paper aus der Bibliothek wählen…',
      memberAdd: 'Paper hinzufügen',
      memberAdded: 'Paper zur Wissensbasis hinzugefügt.',
      memberAddFailed: 'Hinzufügen des Papers fehlgeschlagen.',
      membersEmpty: 'Noch keine Paper in dieser Wissensbasis.',
      memberFileMissing: 'PDF fehlt',
      memberRemove: 'Entfernen',
      memberRemoved: 'Paper aus der Wissensbasis entfernt.',
      memberRemoveFailed: 'Entfernen des Papers fehlgeschlagen.',
      memberRemoveConfirmText: '"{name}" aus dieser Wissensbasis entfernen?',
      askTitle: 'Diese Wissensbasis befragen',
      questionPlaceholder: 'Stelle eine Frage zu den Papers in dieser Wissensbasis…',
      ask: 'Fragen',
      askFailed: 'Die Frage ist fehlgeschlagen.',
      askNeedsIndex: 'Erst den Index erstellen — Fragen benötigen eine indizierte Wissensbasis.',
      historyEmpty: 'Noch keine Fragen gestellt.',
      questionFailed: 'Die Frage ist fehlgeschlagen.',
...
jobTriggered: 'Job ausgelost',
  ...
  workflow: {
    ...
    actions: {
      newWorkflow: 'Neuer Workflow', addNode: 'Knoten hinzufügen', addNodeResearch: 'Forschungsknoten hinzufügen', createWorkflowFirst: 'Bitte zuerst einen Workflow erstellen', reset: 'Zurücksetzen',
    ...
    runs: {
      ...
      nodeSessionTitle: 'Knotensitzung – {node}', noNodeSession: 'Für diesen Knoten gibt es noch keine Sitzung', loadNodeSessionFailed: 'Knotensitzung konnte nicht geladen werden', stop: 'Ausführung stoppen', stopRequested: 'Stopp angefordert', stopFailed: 'Ausführung konnte nicht gestoppt werden', delete: 'Eintrag löschen', deleteSuccess: 'Ausführungseintrag gelöscht',
          notificationTitle: 'Workflow „{name}“ beendet',
      notificationCompleted: 'Der Lauf wurde erfolgreich abgeschlossen.',
      notificationFailed: 'Der Lauf ist fehlgeschlagen. Öffnen Sie den Lauf, um Knotenfehler zu prüfen.',
      notificationCanceled: 'Der Lauf wurde abgebrochen.',
},
    ...
    node: {
      ...
      promptPlaceholder: 'Beschreiben Sie, was dieser Agent tun soll...', skillsPlaceholder: 'Skills eingeben und mit Enter hinzufügen', uploadImages: 'Bilder hochladen', readonlyBadge: 'Schreibgeschützt',
    },
    nodeType: {
      script: 'Skript',
