...
export default {
  ...
  research: {
    ...
    workflows: {
      templatesTitle: '템플릿 라이브러리',
      templatesLoading: '템플릿을 불러오는 중…',
      templatesLoadFailed: '템플릿 라이브러리를 불러오지 못했습니다.',
      retry: '재시도',
      useTemplate: '이 템플릿 사용',
      nodeCount: '{count}개 노드',
      myWorkflowsTitle: '내 워크플로',
      flowsLoading: '워크플로를 불러오는 중…',
      flowsLoadFailed: '워크플로 목록을 불러오지 못했습니다.',
      flowsEmpty: '아직 워크플로가 없습니다',
      flowsEmptyHint: '위의 템플릿 라이브러리에서 템플릿을 선택해 첫 리서치 파이프라인을 만들어 보세요.',
      open: '열기',
      delete: '삭제',
      deleteConfirm: '삭제',
      cancel: '취소',
      deleteConfirmText: '워크플로 "{name}"을(를) 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
      deleteSuccess: '워크플로가 삭제되었습니다.',
      deleteFailed: '워크플로 삭제에 실패했습니다.',
      untitledFlow: '제목 없는 워크플로',
      createModalTitle: '템플릿에서 워크플로 만들기',
      createNameLabel: '워크플로 이름',
      createNamePlaceholder: '이 리서치 파이프라인의 이름을 지정하세요',
    ...
    artifacts: {
      allTypes: '모든 유형',
      keywordPlaceholder: '제목 또는 실행 ID 검색',
      loading: '결과물을 불러오는 중…',
      loadFailed: '결과물 목록을 불러오지 못했습니다.',
      retry: '다시 시도',
      empty: '아직 결과물이 없습니다. LaTeX 문서를 컴파일하면 생성된 PDF가 자동으로 여기에 등록되며, 워크플로 실행 결과물도 이 목록에 표시됩니다.',
      emptyFiltered: '필터 조건에 일치하는 결과물이 없습니다.',
      untitled: '제목 없는 결과물',
      sourceNone: '실행 출처 없음',
      preview: '미리보기',
      previewFrame: '결과물 미리보기',
      openInNewWindow: '새 창으로 열기',
      previewMetaTitle: '미리보기 정보',
      previewEmpty: '이 결과물에는 아직 미리보기 정보가 없습니다.',
      close: '닫기',
      sendToChat: '채팅으로 보내기',
      sendToChatSuccess: '결과물을 채팅으로 보냈습니다.',
      sendToChatFailed: '결과물을 채팅으로 보내지 못했습니다.',
      delete: '삭제',
      deleteConfirm: '삭제',
      deleteConfirmText: '"{name}"을(를) 결과물 목록에서 삭제할까요? 등록 기록만 제거됩니다.',
      deleteFailed: '결과물 삭제에 실패했습니다.',
      deleteSuccess: '결과물을 삭제했습니다.',
      cancel: '취소',
      typeLabels: {
        html: 'HTML 페이지',
        svg: 'SVG 그림',
        pptx: 'PPTX 프레젠테이션',
        drawio: 'draw.io 다이어그램',
        pdf: 'PDF 문서',
        latex: 'LaTeX 소스',
        figure: '그림',
      },
    ...
    latex: {
      ...
      previewEmpty: '문서를 컴파일하면 PDF 미리보기가 표시됩니다.',
      previewFailed: 'PDF 미리보기를 불러오지 못했습니다.',
      errorPanelTitle: '컴파일 오류',
      noErrors: '오류가 없습니다.',
      statusQueued: '대기 중',
      statusRunning: '컴파일 중',
      statusCompleted: '완료',
      statusFailed: '실패',
      engineUnavailable: '서버에서 Tectonic을 사용할 수 없습니다. TECTONIC_BIN을 설정하거나 tectonic을 PATH에 설치하세요.',
      compileConflict: '이 문서에는 이미 컴파일 작업이 대기 중이거나 실행 중입니다.',
      loadFailed: 'LaTeX 문서를 불러오지 못했습니다.',
      lineLabel: '{line}행',
      loading: '불러오는 중…',
    ...
    rag: {
      ...
      create: '만들기',
      created: '지식 베이스가 생성되었습니다.',
      createFailed: '지식 베이스 생성에 실패했습니다.',
      loading: '지식 베이스를 불러오는 중…',
      loadFailed: '지식 베이스를 불러오지 못했습니다.',
      retry: '재시도',
      empty: '아직 지식 베이스가 없습니다',
      paperCount: '논문 {count}편',
      delete: '삭제',
      cancel: '취소',
      deleteConfirmText: '지식 베이스 "{name}"을(를) 삭제할까요? 멤버 논문과 질문 기록이 함께 삭제됩니다.',
      deleted: '지식 베이스가 삭제되었습니다.',
      deleteFailed: '지식 베이스 삭제에 실패했습니다.',
      selectHint: '지식 베이스를 선택하여 논문을 관리하고 질문하세요.',
      status: {
        unindexed: '미색인',
        indexing: '색인 중',
        indexed: '색인됨',
      ...
      index: '색인 만들기',
      reindex: '색인 다시 만들기',
      indexCompleted: '색인이 완성되었습니다.',
      indexFailed: '색인 생성에 실패했습니다.',
      chunks: '{engine} 통해 {count}개 청크',
      membersTitle: '멤버 논문',
      memberPlaceholder: '라이브러리에서 논문 선택…',
      memberAdd: '논문 추가',
      memberAdded: '지식 베이스에 논문을 추가했습니다.',
      memberAddFailed: '논문 추가에 실패했습니다.',
      membersEmpty: '이 지식 베이스에는 아직 논문이 없습니다.',
      memberFileMissing: 'PDF 없음',
      memberRemove: '제거',
      memberRemoved: '지식 베이스에서 논문을 제거했습니다.',
      memberRemoveFailed: '논문 제거에 실패했습니다.',
      memberRemoveConfirmText: '이 지식 베이스에서 "{name}"을(를) 제거할까요?',
      askTitle: '이 지식 베이스에 질문하기',
      questionPlaceholder: '이 지식 베이스의 논문에 대해 질문하세요…',
      ask: '질문',
      askFailed: '질문에 실패했습니다.',
      askNeedsIndex: '먼저 색인을 만드세요 — 질문에는 색인된 지식 베이스가 필요합니다.',
      historyEmpty: '아직 질문 기록이 없습니다.',
      questionFailed: '질문에 실패했습니다.',
